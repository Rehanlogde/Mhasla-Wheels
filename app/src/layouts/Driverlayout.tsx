...
const navItems = [
    { label: "Customers booking", path: "/driver/bookings" },
    {label : "Payments", path : "/driver/payments"},
    {label : 'Scanner',  path : '/driver/scanner'}
];
        ...
        <div className="min-h-screen bg-[#0A0A0A] text-white">
            ...
            <div className="sticky top-0 bg-[#111] border-b border-gray-700 shadow-lg p-4 flex flex-col md:flex-row items-center justify-between gap-3 z-50">
                <div className="flex items-center gap-6">
                    <h1 className="text-2xl font-bold text-red-500">Captain Panel</h1>
